...
'''
This file pretends to be the main program of pyminer, which implements
...
class MainForm :
    ...
    def load_extension(self, extension_package: str):
        package_path = f'pyminer/features/extensions/test_demo/extensions/{extension_package}'
        ...
        # allow main program to update menu and subwindows to GUI after they are created
