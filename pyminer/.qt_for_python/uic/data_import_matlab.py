...
################################################################################
## Form generated from reading UI file 'data_import_matlab.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon = QIcon()
        icon.addFile(u":/resources/icons/matlab.svg", QSize(), QIcon.Normal, QIcon.Off)
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QCoreApplication.translate("Form", u"\u5bfc\u5165MATLAB\u6570\u636e", None))
