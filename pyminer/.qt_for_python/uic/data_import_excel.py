...
################################################################################
## Form generated from reading UI file 'data_import_excel.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon = QIcon()
        icon.addFile(u":/resources/icons/excel.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.horizontalSpacer_10 = QSpacerItem(37, 22, QSizePolicy.Expanding, QSizePolicy.Minimum)
        ...
        self.comboBox_sheet = QComboBox(Form)
        self.comboBox_sheet.setObjectName(u"comboBox_sheet")
        self.comboBox_sheet.setMinimumSize(QSize(150, 25))
        self.comboBox_sheet.setMaximumSize(QSize(100, 16777215))
        ...
        self.pushButton_ok_2 = QPushButton(self.widget)
        self.pushButton_ok_2.setObjectName(u"pushButton_ok_2")
        self.pushButton_ok_2.setMinimumSize(QSize(0, 25))
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QCoreApplication.translate("Form", u"\u5bfc\u5165EXCEL\u6570\u636e", None))
        ...
        self.label_9.setText(QCoreApplication.translate("Form", u"\u6570\u636e\u96c6\u540d\uff1a", None))
        self.lineEdit_datasetName.setText(QCoreApplication.translate("Form", u"0", None))
        ...
        self.label_6.setText(QCoreApplication.translate("Form", u"\u6570\u636e\u4f4d\u7f6e\uff1a", None))
        ...
        self.pushButton_ok_2.setText(QCoreApplication.translate("Form", u"\u5e2e\u52a9", None))
