...
################################################################################
## Form generated from reading UI file 'data_import_oracle.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon = QIcon()
        icon.addFile(u":/resources/icons/oracle.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.spinBox_port.setValue(1521)
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox_database.setItemText(0, QCoreApplication.translate("Form", u"Oracle", None))

        self.label_username.setText(QCoreApplication.translate("Form", u"\u7528\u6237\u540d\uff1a", None))
        self.lineEdit_user.setInputMask("")
        self.lineEdit_user.setText(QCoreApplication.translate("Form", u"SCOTT", None))
        ...
        self.lineEdit_db.setText(QCoreApplication.translate("Form", u"ORCL", None))
        ...
        self.lineEdit_table.setText(QCoreApplication.translate("Form", u"EMP", None))
