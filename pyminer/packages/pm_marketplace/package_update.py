...
################################################################################
## Form generated from reading UI file 'package_update.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayout.setWidget(1, QFormLayout.LabelRole, self.checkBox_version)
        ...
        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.comboBox_version)
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QCoreApplication.translate("Form", u"\u66f4\u65b0", None))
