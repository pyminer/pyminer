...
from PyQt5.QtCore import pyqtSignal, QTimer, QRectF, Qt, QSize
from PyQt5.QtGui import QColor, QPainter, QPainterPath, QPixmap, QImage
from PyQt5.QtWidgets import QListWidget, QWidget, QListWidgetItem, QHBoxLayout, QGridLayout, QLabel, QSpacerItem, \
