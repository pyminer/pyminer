...
class PMPagePlot(QWidget):
    def __init__(self):
        super().__init__()
        from .resources import icon_dbdistinctvalues, icon_netfill, icon_stockcolumns, icon_nostackdirectboth_52x60, \
            icon_bubble, icon_areas, icon_nostackdirectboth_52x60, icon_pie, icon_areaspiled, icon_columns_52x60
...
class ExtInfoWidget(QWidget):
    ...
    def init_ui(self):
        ...
        ), 'features/extensions/packages/', self.ext.info.name, self.ext.info.icon)
