# 也就是widget_right
from PyQt5.QtWidgets import QWidget, QGridLayout, QToolButton, QSpacerItem, QSizePolicy, QMainWindow, \
...
class PMPageData(QWidget):
    def __init__(self, main_window: QMainWindow):
        super().__init__()
        from .resources import icon_lc_connectorcurve, icon_transition_random, icon_formfilternavigator, icon_data_provider, icon_lc_togglemergecells, icon_lc_datadatapilotrun, icon_delete_columns, icon_mergedocuments, icon_lc_accepttrackedchange, \
            icon_lc_datasubtotals, icon_dbdistinctvalues, icon_entirecolumn, icon_lc_selectdb, icon_lc_dbviewtablenames, icon_graphicfilterpopart, icon_deleterows, icon_lc_renametable, icon_lc_formatcolumns, icon_lc_dataarearefresh, icon_NavOverFlow_Info

        self.main_window = main_window
        self.gridLayout = QGridLayout(self)
        self.btn_data_filter = QToolButton(self)
        ...
        self.btn_data_sample = QToolButton(self)
        ...
        self.btn_data_new_column = QToolButton(self)
        ...
        self.btn_data_row_filter = QToolButton(self)
        ...
        self.btn_data_column_encode = QToolButton(self)
        self.btn_data_column_encode.setMinimumSize(QSize(80, 60))
        self.btn_data_column_encode.setMaximumSize(QSize(80, 60))
        icon29 = QIcon()
        icon29.addPixmap(QPixmap(":/pyqt/source/images/wordcountdialog.png"), QIcon.Normal, QIcon.Off)
        self.btn_data_column_encode.setIcon(icon29)
        self.btn_data_column_encode.setIconSize(QSize(32, 32))
        self.btn_data_column_encode.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
        ...
        self.btn_data_merge_horizontal = QToolButton(self)
        ...
        self.btn_data_merge_horizontal.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
        ...
        self.btn_data_transpose = QToolButton(self)
        ...
        self.btn_data_replace = QToolButton(self)
        ...
        self.btn_data_missing_value = QToolButton(self)
        ...
        self.btn_data_missing_value.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
        ...
        self.btn_data_column_name = QToolButton(self)
        ...
        self.btn_data_info = QToolButton(self)
        ...
        self.btn_data_merge_vertical = QToolButton(self)
        ...
        self.btn_data_merge_vertical.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
        ...
        self.btn_delete_column = QToolButton(self)
        ...
        self.btn_data_sort = QToolButton(self)
        ...
        self.btn_data_partition = QToolButton(self)
        ...
        self.btn_delete_row = QToolButton(self)
        ...
        self.btn_data_role = QToolButton(self)
        ...
        self.btn_data_column_desc = QToolButton(self)
    ...
    def retranslate_UI(self):
        ...
        # 按钮特效测试
        self.effect = QGraphicsDropShadowEffect()  # 实例阴影
        self.effect.setColor(QColor(63, 72, 204))  # 设置阴影颜色
        self.effect.setOffset(0, 0)  # 设置阴影方向
        self.effect.setBlurRadius(20)  # 设置模糊度

    def bind_events(self):
        app = self.main_window
        self.btn_data_column_desc.clicked.connect(app.data_column_desc_display)  # 列出数据
        # 特效测试。注意这里的更改，改在了page_data中。
        self.btn_data_row_filter.setGraphicsEffect(self.effect)
        ...
        self.btn_delete_row.clicked.connect(app.data_delete_col_display)
        # 纵向合并

        self.btn_data_merge_vertical.clicked.connect(app.data_merge_vertical_display)
        # 横向合并

        self.btn_data_merge_horizontal.clicked.connect(app.data_merge_horizontal_display)
        # 数据分区
        ...
        # 数据-缺失值
        self.btn_data_missing_value.clicked.connect(app.data_missing_value_display)
        # 数据-筛选和排序
        ...
        # 数据-数据编码
        self.btn_data_column_encode.clicked.connect(app.data_column_encode_display)


class PMPageStats(QWidget):
    def __init__(self, main_window: QMainWindow):
        super().__init__()
        from .resources import icon_wordcountdialog, icon_distributecolumns, icon_dbdistinctvalues, icon_formfilternavigator, icon_lc_closedoc
        self.main_window = main_window
        ...
        self.btn_stats_base = QToolButton(self)
        ...
        self.btn_stats_distribution = QToolButton(self)
        ...
        self.btn_stats_distribution.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
        self.gridLayout_2.addWidget(self.btn_stats_distribution, 3, 0, 1, 1)
        self.btn_stats_sum = QToolButton(self)
        ...
        self.btn_stats_frequency = QToolButton(self)
        ...
        self.btn_stats_corr = QToolButton(self)
        ...
        self.btn_stats_t = QToolButton(self)
        ...
        self.btn_stats_missing_value = QToolButton(self)
        ...
        self.btn_stats_missing_value.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
        ...
        self.btn_stats_except_value = QToolButton(self)
        ...
        self.btn_stats_except_value.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
        ...
        self.btn_stats_unique_value = QToolButton(self)
        ...
        self.btn_stats_unique_value.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
    ...
    def bind_events(self):
        app = self.main_window
        self.btn_stats_base.clicked.connect(app.stats_base_display)  # 显示“描述统计”窗口


class PMPagePlot(QWidget):
    def __init__(self, main_window: QMainWindow):
        super().__init__()
        from .resources import icon_dbdistinctvalues, icon_netfill, icon_stockcolumns, icon_nostackdirectboth_52x60, icon_bubble, icon_areas, icon_nostackdirectboth_52x60, icon_pie, icon_areaspiled, icon_columns_52x60
        self.main_window = main_window

        self.gridLayout_3 = QGridLayout(self)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.btn_plot_box = QToolButton(self)
        ...
        self.btn_plot_line = QToolButton(self)
        ...
        self.btn_plot_radar = QToolButton(self)
        ...
        self.btn_plot_scotter = QToolButton(self)
        ...
        self.btn_plot_area = QToolButton(self)
        ...
        self.btn_plot_pie = QToolButton(self)
        ...
        self.btn_plot_heap = QToolButton(self)
        ...
        self.btn_plot_hist = QToolButton(self)
        ...
        self.btn_plot_bar = QToolButton(self)
        ...
        self.btn_plot_missing_value = QToolButton(self)
        ...
        self.btn_plot_missing_value.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
        ...
        self.btn_plot_radar_3 = QToolButton(self)
        ...
        self.btn_plot_radar_4 = QToolButton(self)
    ...
    def bind_events(self):
        self.btn_plot_hist.clicked.connect(self.main_window.plot_frame_display)  # 打开"数据可视化-直方图"窗口
...
class PMPageModel(QWidget):
    def __init__(self, main_window: QMainWindow):
        ...
        self.btn_model_cnn = QToolButton(self)
        ...
        self.btn_model_time_seires = QToolButton(self)
        ...
        self.btn_model_time_seires.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
        ...
        self.btn_model_scorecard = QToolButton(self)
        ...
        self.btn_model_3 = QToolButton(self)
        ...
        self.btn_model_tree = QToolButton(self)
        ...
        self.btn_model_1 = QToolButton(self)
        ...
        self.btn_model_2 = QToolButton(self)
        ...
        self.btn_model_logist = QToolButton(self)
        ...
        self.btn_model_linear_regression = QToolButton(self)
        ...
        self.btn_model_linear_regression.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
        ...
        self.btn_model_4 = QToolButton(self)
    ...
    def bind_events(self):
        app = self.main_window
        self.btn_model_linear_regression.clicked.connect(app.model_frame_display)  # 展示模型页面
        self.btn_model_tree.clicked.connect(app.model_tree_display)  # 打开"模型-决策树"窗口
...
class PMPage(QWidget):
    def __init__(self, main_window):
        ...
        self.btn_assess_auc = QToolButton(self)
        ...
        self.btn_assess_feature_select = QToolButton(self)
        ...
        self.btn_assess_feature_select.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
        ...
        self.btn_assess_iv = QToolButton(self)
        ...
        self.btn_access_fine = QToolButton(self)
        ...
        self.btn_assess_psi = QToolButton(self)
        ...
        self.btn_assess_woe = QToolButton(self)
        ...
        self.btn_access_model = QToolButton(self)
