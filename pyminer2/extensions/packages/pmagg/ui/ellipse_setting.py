...
class Window(QtWidgets.QDialog):
    def __init__(self, event, canvas):
        ...
        self.center_lineedit.setText('(%.2f,%.2f)' % event.artist.get_center())
        self.linewidth_lineedit.setText('%.2f' % event.artist.get_linewidth())
        ...
        self.layout.addRow('中心坐标', self.center_lineedit)
    ...
    def confirm_slot(self):
        ...
        self.artist.set_center(tuple(eval(self.center_lineedit.text())))
