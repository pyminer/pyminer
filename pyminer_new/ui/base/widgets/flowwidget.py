...
class PMFlowWidget(QWidget):
    def __init__(self):
        from .resources import icon_lc_save, icon_sc_shadowcurser, icon_lc_connectorlinesarrowend, icon_lc_undo, icon_lc_redo, icon_sc_deletepage, icon_lc_aligncenter, icon_lc_alignmiddle, icon_lc_zoomin, icon_lc_zoomout, icon_dataprovider, \
