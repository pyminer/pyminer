...
from pyminer_new.ui.generalwidgets import PMToolButton
...
class PMToolbarTabHome(PMModernToolbarTab):
    def __init__(self, tab_name: str):
        from pyminer_new.ui.base.widgets.resources import icon_python, icon_lc_save, icon_New
        ...
        icon_load_data = QIcon(
            '/media/hzy/程序/novalide/forgitcommit/pyminer_new/pyminer_new/pyminer_new/ui' + '/source/images/dbqueryedit.png')
        self.current_col = 0
