...
from PyQt5.QtWidgets import QWidget, QGridLayout, QSpacerItem, QSizePolicy, QMainWindow, QListWidget, QListWidgetItem, \
    QHBoxLayout, QLabel, QPushButton, QFileDialog, QVBoxLayout, QMenu
...
from pyminer_new.ui.generalwidgets.buttons import PMToolButton
...
class PMPageData(QWidget):
    ...
    def setup_ui(self):
        ...
        from .resources import icon_lc_connectorcurve, icon_transition_random, icon_formfilternavigator, \
            ...
            icon_lc_datasubtotals, icon_dbdistinctvalues, icon_entirecolumn, icon_lc_selectdb, icon_lc_dbviewtablenames, \
            icon_graphicfilterpopart, icon_deleterows, icon_lc_renametable, icon_lc_formatcolumns, \
            icon_lc_dataarearefresh, icon_NavOverFlow_Info
...
class PMPagePlot(QWidget):
    def __init__(self):
        super().__init__()
        from .resources import icon_dbdistinctvalues, icon_netfill, icon_stockcolumns, icon_bubble, icon_areas, icon_nostackdirectboth_52x60, icon_pie, icon_areaspiled, icon_columns_52x60
