...
if TYPE_CHECKING:
    from pyminer_new.pmappmodern import PMToolBarHome
    from pyminer_new.ui.generalwidgets import PMDockWidget, ActionWithMessage, PMToolBar
...
class BaseMainWindow(QMainWindow):
    ...
    def init_toolbar_tab(self):
        from pyminer_new.ui.generalwidgets import TopToolBar
        tt = TopToolBar()
    ...
    def add_toolbar(self, name: str, toolbar: QToolBar, text: str = 'untitled toolbar'):
        ...
        # from pyminer_new.ui.generalwidgets.buttons import PushButtonPane
    ...
    def add_widget_on_dock(self, dock_name: str, widget: QWidget, text: str = '', side='left'):
        from pyminer_new.ui.generalwidgets import PMDockWidget, ActionWithMessage
    ...
    def get_dock_widget(self,widget_name:str)->PMDockWidget:
        ...
        if dw is None:
            raise Exception('dockwidget named \'%s\' is not defined!'%widget_name)
        return dw

    def refresh_view_configs(self):
        from pyminer_new.ui.generalwidgets import ActionWithMessage
