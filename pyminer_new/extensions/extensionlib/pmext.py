...
if TYPE_CHECKING:
    from pyminer_new.pmappmodern import MainWindow
    from pyminer_new.ui.base.widgets.consolewidget import ConsoleWidget
    from pyminer_new.workspace.datamanager import DataManager
    from pyminer_new.ui.generalwidgets import PMToolBar
...
class PluginInterface(object):
    ...
    def get_root_dir() -> str:
        ...
        获取项目的根目录
        '''
        return pyminer_new.pmutil.get_root_dir()
    ...
    def get_main_window() -> "MainWindow":
        ...
        获取应用主界面
        '''
        return pyminer_new.pmutil.get_main_window()

    @staticmethod
    def shell() -> "ConsoleWidget":
        '''
        获取Ipython shell窗口，返回的是shell控件。
        '''
